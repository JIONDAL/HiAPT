...
public class costPayFormService {
	...
	public String unpaid() {
		if (costDao.unpaid(AptDTO.getId()) != null) {
			return costDao.unpaid(AptDTO.getId());
		} else {
			return "0";
		}
	}
	...
	public void setMymoney(String balance) { 
		costDao.setMymoney(AptDTO.getId(), balance);
	}
	
	//납부 상태를 '미납 -> 납부'로 변경
	public void statusUpdate(String id, String year, String month) {
		costDao.statusUpdate(AptDTO.getId(), year, month);
	}
}
